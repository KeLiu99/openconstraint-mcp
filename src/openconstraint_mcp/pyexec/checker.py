...
def _execute_checker(
    ...
    *,
    ...
    try:
        ...
        # non-zero-exit branch below, which would otherwise report the absence of
        # a process as "exited with non-zero code: None".
        return _error(
            f"checker process could not be started: {exc}",
            stdout="",
            stderr="",
            duration_ms=0,
        )
