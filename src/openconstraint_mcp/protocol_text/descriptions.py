...
RUN_CPSAT_PYTHON_FILE_CHECKED_DESCRIPTION = (
    ...
    "and numeric-or-boolean field perturbation. `checker_test` includes the "
    "`baseline`, one `mutations` row per probe, and `rejected_count`/"
    "`accepted_count`; the counts exclude errors, timeouts, and skipped probes. "
