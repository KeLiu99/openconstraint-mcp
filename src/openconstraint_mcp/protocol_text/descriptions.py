...
RUN_CPSAT_PYTHON_EXPERIMENT_DESCRIPTION = (
    ...
    "(optimal > feasible > timeout) then earliest attempt order. In feasibility "
    "mode, objective is not required and winner selection uses stronger status "
    "then earliest attempt order. "
    ...
    "`problem_sha256`. A `timeout` winner is "
